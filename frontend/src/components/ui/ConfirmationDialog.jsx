...
export default function ConfirmationDialog({
  ...
  return (
    <div className="confirmation-dialog-backdrop" role="presentation">
      <section aria-describedby={descriptionId} aria-labelledby={titleId} aria-modal="true" className={`confirmation-dialog confirmation-dialog-${confirmTone}${size === "wide" ? " confirmation-dialog-wide" : ""}${dialogClassName ? ` ${dialogClassName}` : ""}`} onKeyDown={trapFocus} ref={dialogRef} role="dialog">
        ...
        <div className={descriptionClassName} id={descriptionId}>{typeof description === "string" ? <p>{description}</p> : description}</div>
