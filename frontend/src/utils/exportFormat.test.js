...
describe("export formatting", () => {
  ...
  it("creates an ordered, clone-safe workspace backup", () => {
    ...
    expect(backup.counts).toEqual({ resume_versions: 2, resume_version_files: 0, applications: 4, application_activities: 2, application_ai_briefs: 0 });
    expect(backup.data.resume_version_files).toEqual([]);
