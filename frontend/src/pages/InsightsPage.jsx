...
export default function InsightsPage() {
  ...
  useEffect(() => {
    getOutcomeInsights().then(setData).catch((reason) => setError(reason.message || "Could not load outcome insights."));
  }, []);
