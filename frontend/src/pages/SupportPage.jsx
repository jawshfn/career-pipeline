...
const commonTasks = [
  ...
  { title: "Manage resume versions", description: "Create and update resume versions, attach one PDF, and mark one active version as the default for new Add Job drafts. Browser Capture stays quick: confirm or change that resume before saving. You can also review and assign the default only to currently unassigned applications; existing assignments are never replaced.", action: "Open Resumes", page: "resume-versions" },
    ...
    <div className="support-page" id="help-top">
      ...
      <section className="panel support-panel" id="help-data" aria-labelledby="data-help-heading">
        ...
        <div className="support-disclosure-list">
          ...
          <details className="support-disclosure"><summary>Export &amp; backup</summary><div className="support-disclosure-content"><p>An application export is a spreadsheet for review or re-import. A complete workspace JSON backup includes attached resume PDFs and the default-resume designation.</p></div></details>
