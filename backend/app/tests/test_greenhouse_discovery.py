...
@pytest.mark.parametrize(
    ...
    [
        ...
        '<section id="greenhouse-jobs" data-board-token="fictionalsystems"></section>',
        '<script src="https://boards.greenhouse.io/assets/embed.js" data-board-token="fictionalsystems"></script>',
        '<script>Greenhouse.init({ boardToken: "fictionalsystems" });</script>',
        '<script>Grnhse.Iframe.load("fictionalsystems");</script>',
        '<script>const greenhouseApiUrl = "https://boards-api.greenhouse.io/v1/boards/fictionalsystems";</script>',
