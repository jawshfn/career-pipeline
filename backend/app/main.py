...
from .routers import applications, browser_captures, dashboard, exports, insights, job_imports, resume_versions, workspace_imports
...
app = FastAPI(title="PursuitHQ API", lifespan=lifespan)
