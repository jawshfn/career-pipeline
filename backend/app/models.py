...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, Index, Integer, LargeBinary, String, Text, event, text
from sqlalchemy.orm import Mapped, mapped_column, relationship

from .database import Base
from .domain import JOB_LINK_MAX_LENGTH, SAVED_APPLICATION_STATUS, furthest_stage_for
...
class ResumeVersion(Base):
    ...
    __table_args__ = (
        Index(
            "uq_resume_versions_single_default",
            "is_default",
            unique=True,
...
class Application(Base):
    ...
    job_link: Mapped[str | None] = mapped_column(String(JOB_LINK_MAX_LENGTH), nullable=True)
