...
- Smart Capture paste-review workflow that prepares editable suggested fields before saving
...
Deployment, authentication, AI features, scraping, browser extension workflows, and advanced analytics are not implemented. Smart Capture uses deterministic paste-review helpers today; AI-assisted extraction is an optional future direction rather than a current product claim.
